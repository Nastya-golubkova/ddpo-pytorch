...
def jpeg_aesthetic_hybrid():
    """JPEG compressibility (0.3) + aesthetic score (0.7); components z-scored per batch before mixing."""
    config = aesthetic()
    config.reward_fn = "jpeg_aesthetic_03_07"
